...
describe 'Creating Transactions' do
  ...
  before do
    ...
    # "Signature shielding"
    command.call(name: 'T1', account_id: account.id, amount: 100.0, currency: :usd, scenario_id: 1, recurrence_rule: 'placeholder')
  end
...
describe 'Retrieving Transactions' do
  ...
  before do
    subject.create_transaction(name: 'T1', account_id: account.id, amount: 100.0, currency: :usd,
                               scenario_id: 1, recurrence_rule: 'placeholder')
